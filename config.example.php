<?php
// Exemplo de configuração - Copie para config.php e ajuste

// Configurações do banco de dados
define('DB_HOST', 'localhost');
define('DB_NAME', 'smartvamp');
define('DB_USER', 'seu_usuario_mysql'); // Altere para seu usuário MySQL
define('DB_PASS', 'sua_senha_mysql');   // Altere para sua senha MySQL
